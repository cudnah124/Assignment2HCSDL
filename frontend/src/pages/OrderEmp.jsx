                ...
                <div className={styles.table}>
                    <div className="order-row header">
                        <span>
                            ...
                            <button
                                ...
                                title={`Sort by Order ID (${isAscending ? "Ascending" : "Descending"})`}
                            >
                                {isAscending ? <HiOutlineSortAscending /> : <HiOutlineSortDescending />}
                            </button>
                        </span>
                    ...
                    {orders.map((order) => (
                        <div className="order-row" key={order.id}>
                            ...
                            <span>{order.bill.toLocaleString()}</span>
            ...
            {selectedOrder && (
                <div className="popup-overlay" onClick={() => setSelectedOrder(null)}>
                    <div className="popup-content" onClick={(e) => e.stopPropagation()}>
                        ...
                        <p><strong>Total:</strong> {selectedOrder.bill.toLocaleString()}</p>
